...
public class MoveLeftTests {
    @Test
    public void Test_MoveLeftFromStart() {
        ...
        tetrisFieldController.MoveLeftFigure();
    ...
    @Test
    public void Test_MoveLeftCloseToBorder() {
        var tetrisFieldController = new TetrisFieldController(10, 20);

        var figure = new WandFigure(Color.BLACK);

        var field1 = new Field(Color.BLACK);
        field1.Position = new Point(0, 1);
        var field2 = new Field(Color.BLACK);
        field2.Position = new Point(0, 2);
        var field3 = new Field(Color.BLACK);
        field3.Position = new Point(0, 3);
        var field4 = new Field(Color.BLACK);
        field4.Position = new Point(0, 4);
